...
if( !class_exists( 'IterableData' ) ) {
	class IterableData {
		...
		public static function get_iterable_table_name(){
			global $wpdb;
		...
		public static function drop_tables(){
			global $wpdb;
			$wpdb->query("DROP TABLE IF EXISTS " . self::get_iterable_table_name());
		}
	}
}
